    ...
    public static void main(String[] args) {
        ...
        if (testCase == 1) { //Test for String,Integer
            ...
            * */
            ...
            rules.add(new Rule<>(s -> s.contains("NP"),
                    s -> s.indexOf("NP")));
            ...
            * */
            ...
            rules.add(new Rule<>(s -> s.startsWith("NP"),
                    String::length));
            ...
            rules.add(new Rule<>(student -> student.grades.size() >= 3,
                    student -> student.grades.stream().mapToDouble(grade -> grade)
                            .max().getAsDouble()));
            ...
            rules.add(new Rule<>(student -> student.id.startsWith("20"),
                    student -> student.grades.stream().mapToDouble(grade -> grade).average().orElse(5.0)));
