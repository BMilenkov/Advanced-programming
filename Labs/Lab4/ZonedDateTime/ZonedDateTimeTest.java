package Labs.Lab4.ZonedDateTime;
...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeParse() {
         ...
         */
        String dateTimeString = "2015-06-18 23:07:25.000";
        DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss.SSS");

        return ZonedDateTime.parse(dateTimeString , formatter.withZone(ZoneId.of("Asia/Tokyo")));
    }
